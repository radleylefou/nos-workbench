...
export const productPatterns: ProductPatternDefinition[] = [
  ...
  {
    slug: "form-modal-new-lead",
    title: "Form Modal — New Lead",
    description: "Short single-step create modal for adding a prospect to the pipeline.",
    moduleIds: ["prospect"],
    workflow: "Quick lead capture from a list view",
    layoutVariation: "Centred modal over dimmed list",
    referenceBuckets: ["Apollo", "HubSpot CRM", "Salesforce", "Pipedrive"],
    composedComponents: ["FormModal", "Input", "Label", "Button"],
    acceptanceCheck: "A user can open the modal, fill in name, email, and company, and add a lead without leaving the list view.",
  },
  {
    slug: "form-modal-new-engagement",
    title: "Form Modal — New Engagement",
    description: "Medium single-step create modal with badge header for starting a client engagement.",
    moduleIds: ["engage"],
    workflow: "New engagement creation from the portfolio dashboard",
    layoutVariation: "Centred modal with module badge over dimmed dashboard",
    referenceBuckets: ["Salesforce", "HubSpot", "Gainsight", "Productive", "Kantata"],
    composedComponents: ["FormModal", "Input", "Select", "Badge", "Label", "Button"],
    acceptanceCheck: "A user can open the modal from the portfolio dashboard, set client, type, stage, owner, and start date, and create a new engagement.",
  },
  {
    slug: "form-modal-add-team-member",
    title: "Form Modal — Add Team Member",
    description: "Long scrollable single-step modal for assigning a person to an engagement.",
    moduleIds: ["staff", "engage"],
    workflow: "Team member assignment to an active engagement",
    layoutVariation: "Centred scrollable modal over team list",
    referenceBuckets: ["Runn", "Productive", "Kantata", "Float", "Resource Guru"],
    composedComponents: ["FormModal", "Input", "Select", "Textarea", "Separator", "Label", "Button"],
    acceptanceCheck: "A user can assign a person with role, allocation percentage, dates, and engagement context without leaving the team view.",
  },
  {
    slug: "form-modal-create-scope-item",
    title: "Form Modal — Create Scope Item (Multi-step)",
    description: "Two-step create modal for scope items with basics on step 1 and estimation on step 2.",
    moduleIds: ["scope", "estimate"],
    workflow: "Scope item creation with step-by-step field collection",
    layoutVariation: "Centred multi-step modal with step bar over scope list",
    referenceBuckets: ["Productboard", "Aha!", "Jira Product Discovery", "Linear", "Shortcut"],
    composedComponents: ["FormModal", "Input", "Select", "Textarea", "Label", "Button"],
    acceptanceCheck: "A user can create a scope item by completing basics (title, phase, component, owner) on step 1 and estimation details (points, priority, notes) on step 2.",
  },
  {
    slug: "form-modal-log-activity",
    title: "Form Modal — Log Activity",
    description: "Quick single-step modal for logging an interaction against an engagement.",
    moduleIds: ["engage", "manage"],
    workflow: "Activity logging from engagement detail or activity feed",
    layoutVariation: "Compact centred modal over activity feed",
    referenceBuckets: ["Salesforce", "HubSpot", "Gainsight", "Planhat", "Affinity"],
    composedComponents: ["FormModal", "Select", "Input", "Textarea", "Label", "Button"],
    acceptanceCheck: "A user can log a call, email, or meeting with type, date, and notes in under 30 seconds.",
  },
]
