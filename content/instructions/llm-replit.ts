...
- Copy everything above and paste it into your first Replit Agent message as project context, or save it as **replit.md** at the project root — Replit's Agent reads that file for context and coding style.
